...
public class ProfessorGUI implements ActionListener{
    ...
    void subjects(GridBagConstraints gbc) {
        ...
        while(count<5) {
            gbc.gridx=count;               
            rb = new JRadioButton(subjects[count]);
            rb.setPreferredSize(new Dimension(100,10));
            rb.setMnemonic(KeyEvent.VK_B);
            rb.setActionCommand(subjects[count]);
    ...
    void create2(GridBagConstraints gbc) {
        ...
        try {
            ...
            while(rs.next()) {
                gbc.gridy=y;
                gbc.gridx=0;
                u[y-1] = new JLabel(rs.getString("id"));
    ...
    void createAndShowGUI() {
        ...
        populateGUI();
        professor.add(pane);
        professor.setBounds(400,100,450,250);
    ...
    public void actionPerformed(ActionEvent e) {
        switch (e.getActionCommand()) {
            ...
            default:
                ...
                sql = "Update Student set attendance = "+att[Integer.parseInt(e.getActionCommand())].getText()+", marks = "+mrk[Integer.parseInt(e.getActionCommand())].getText()+" where id = '"+u[Integer.parseInt(e.getActionCommand())].getText()+"' and course = '"+courses[Integer.parseInt(e.getActionCommand())]+"';";
                try {
